...
INNER JOIN time_blk ON appointments.blk_id=time_blk.block_id ORDER BY appointments.date, time_blk.block_id"; 
	#SQL query to retrieve info from DB and join tables together	
